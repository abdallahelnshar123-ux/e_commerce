...
class _ApiServices implements ApiServices {
  ...
  Future<AddToCartResponseDto> addProductToCart(
    AddToCartRequestDto addToCartRequest,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<GetCartResponseDto> getCartItems(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<GetCartResponseDto> updateCartItem(
    String token,
    String productId,
    UpdateProductCountDto updateProductCount,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(updateProductCount.toJson());
    final _options = _setStreamType<GetCartResponseDto>(
